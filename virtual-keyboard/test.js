(() => {
  ...
  function e(e) {
    const t = e.color || "default",
      s = e.size || "1u",
      o = "object" == typeof e.key ? e.key.en : e.key,
      n = document.createElement("button");
    return (
      n.classList.add("btn"),
      n.classList.add(`btn--${t}`),
      n.classList.add(`btn--${s}`),
      n.setAttribute("tabindex", "-1"),
      (n.value = e.code),
      e.system &&
        n.insertAdjacentHTML(
          "beforeend",
          `<span class="btn__syskey">${o}</span>`
        ),
      e.altkey &&
        n.insertAdjacentHTML(
          "beforeend",
          `<span class="btn__altkey">${e.altkey.en}</span>`
        ),
      e.system ||
        n.insertAdjacentHTML(
          "beforeend",
          `<span class="btn__stdkey">${o}</span>`
        ),
      e.icon && (n.innerHTML = `<i class="material-icons">${e.icon}</i>`),
      e.hasLed &&
        n.insertAdjacentHTML("beforeend", '<div class="btn__led"></div>'),
      n
    );
  }
  function t(e) {
  ...
  function o(e, t, s = 1) {
    return t < 0 || t > e.length ? e : e.slice(0, t) + e.slice(t + s);
  }
  const n = new (class {
      constructor(t) {
        (this.keyboard = (function (t) {
          const s = document.createElement("div");
          s.className = "virtual-keyboard";
          ...
          (this.state = { caps: !1, shift: !1, lang: "en" }),
          ...
          window.addEventListener(
            "mouseup",
            this.outsideVirtualKeyboardHandler.bind(this)
          );
      }
      setInput(e) {
        this.input = e;
      ...
      outsideVirtualKeyboardHandler() {
        this.state.shift &&
          ((this.state.shift = !1), this.updateVirtualKeyboard()),
          "down" === this.state.capsState &&
      ...
      realKeyboardKeyHandler(e) {
        this.buttonSet[e.code] &&
          (e.preventDefault(), this.processButton(e.code, e));
      }
      ...
      switchLang(e) {
        ...
        for (let s = 0; s < t.length; s += 1)
          if (
            ("object" == typeof this.buttonSet[t[s].value].key &&
              this.buttonSet[t[s].value].key[e] &&
              (t[s].querySelector(".btn__stdkey").textContent =
                this.buttonSet[t[s].value].key[e]),
            this.buttonSet[t[s].value].altkey)
          )
            if (null === this.buttonSet[t[s].value].altkey[e])
              t[s].querySelector(".btn__altkey")?.remove();
            else {
              t[s].querySelector(".btn__altkey") ||
                t[s].insertAdjacentHTML(
                  "afterbegin",
                  '<span class="btn__altkey"></span>'
                );
              let o = this.buttonSet[t[s].value].altkey.en;
              this.buttonSet[t[s].value].altkey[e] &&
                (o = this.buttonSet[t[s].value].altkey[e]),
                (t[s].querySelector(".btn__altkey").textContent = o);
            }
      }
      processButton(e, n) {
        if (
          ("keydown" === n.type &&
            (document
              .querySelector(`button[value=${e}`)
              .classList.remove("btn--default"),
            document
              .querySelector(`button[value=${e}`)
              .classList.add("btn--pressed")),
          "keyup" === n.type &&
            (document
              .querySelector(`button[value=${e}`)
          ...
          return (
            "mousedown" === n.type && (this.state.capsState = "down"),
            void (
              ("mouseup" !== n.type && "keyup" !== n.type) ||
              ((this.state.caps = !this.state.caps),
              (this.state.capsState = "up"),
              this.updateVirtualKeyboard())
            )
        ...
        if ("ShiftLeft" !== e && "ShiftRight" !== e)
          if ("Backspace" !== e)
            if ("Delete" !== e) {
              if (
                (("ControlLeft" === e || "ControlRight" === e) && n.altKey) ||
                (("AltLeft" === e || "AltRight" === e) && n.ctrlKey)
              )
                ("mousedown" !== n.type && "keydown" !== n.type) ||
                  !0 === n.repeat ||
                  ((this.state.lang = "ru" === this.state.lang ? "en" : "ru"),
                  this.switchLang(this.state.lang));
              else if (!this.buttonSet[e].noAction) {
                if ("mousedown" === n.type || "keydown" === n.type) {
                  let n = "";
                  const c = t(this.input),
                    u = this.input.selectionEnd - this.input.selectionStart;
                  u > 0 && (this.input.value = o(this.input.value, c, u)),
                    (n =
                      "object" == typeof this.buttonSet[e].key
                        ? this.buttonSet[e].key[this.state.lang]
                        : this.buttonSet[e].key),
                    this.state.shift &&
                      this.buttonSet[e].altkey &&
                      (void 0 === this.buttonSet[e].altkey[this.state.lang] &&
                        (n = this.buttonSet[e].altkey.en),
                      this.buttonSet[e].altkey[this.state.lang] &&
                        (n = this.buttonSet[e].altkey[this.state.lang])),
                    (n =
                      (this.state.caps && !this.state.shift) ||
                      (!this.state.caps && this.state.shift)
                        ? n.toUpperCase()
                        : n),
                    (this.input.value =
                      ((i = n),
                      (r = c),
                      (a = this.input.value).slice(0, r) + i + a.slice(r))),
                    s(this.input, c + 1);
                }
                var a, i, r;
                this.input.focus();
              ...
              if ("mousedown" === n.type || "keydown" === n.type) {
                const e = t(this.input),
                  n = this.input.selectionEnd - this.input.selectionStart || 1;
                (this.input.value = o(this.input.value, e, n)),
                  s(this.input, e);
              }
              this.input.focus();
            }
            ...
            if ("mousedown" === n.type || "keydown" === n.type) {
              const e =
                  this.input.selectionEnd - this.input.selectionStart || 1,
                n = t(this.input),
                a = e > 1 ? n : n - 1;
              (this.input.value = o(this.input.value, a, e)), s(this.input, a);
            }
            this.input.focus();
          }
        else {
          ...
          ("mousedown" !== n.type && "keydown" !== n.type) ||
            ((this.state.shift = !0), this.updateVirtualKeyboard());
        }
      }
    })([
      [
      ...
      [
        ...
        { key: "Del", code: "Delete", color: "mod", system: !0 },
      ],
      [
        {
          key: "Ctrl",
